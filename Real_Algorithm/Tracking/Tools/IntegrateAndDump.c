                              ...
                              CorrelatorOutputs *outputs)
{
    ...
    for (int i = 0; i < number_of_samples; i++) {
        ...
        // Vòng phản hồi âm cho nhánh Q để đảm bảo quy ước pha phù hợp với tài liệu tham khảo (Q bị đảo pha 180 độ so với I)
        float baseband_Q = s * (sin_carrier[i]); // Lưu ý dấu âm cho nhánh Q để phù hợp với quy ước pha
